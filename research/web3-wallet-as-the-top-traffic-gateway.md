...
3. **变现上**，钱包已经证明了"入口即生意"：MetaMask 累计 swap 收入约 **2 亿美元**（DefiLlama 链上实收 $1.93 亿 / CoinLaw $1.99 亿，相互印证），Phantom 2025 年收入 **7910 万美元**（协议总收入口径高达 3.26 亿美元），估值 **30 亿美元**。
...
- 累计收入：约 **1.93 亿～1.99 亿美元**（DefiLlama 链上实收 2026-08 实测 $1.929 亿 / CoinLaw $1.986 亿，相互印证）；链上分布：以太坊约 1.4 亿美元、BSC 约 2930 万、Arbitrum 约 747 万、Polygon 约 717 万。注意：二手站流传的"累计 $3.25 亿（DefiLlama 口径）"与 DefiLlama 实际 API 值矛盾（累计值不可能缩水），疑与 Phantom 2025 年总收入 $3.2589 亿混淆，不应引用。
